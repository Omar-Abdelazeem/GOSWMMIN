...
wn.add_reservoir('1', base_head=100+5, head_pattern=None) 


PEOPLE_PER_HOUSEHOLD = 4
HOUSEHOLDS_PER_JUNCTION = 2
LITERS_PER_PERSON_PER_DAY = 50
LITERS_PER_SECOND_PER_PERSON = LITERS_PER_PERSON_PER_DAY / 24 / 3600
BASE_DEMAND_LPS = PEOPLE_PER_HOUSEHOLD * HOUSEHOLDS_PER_JUNCTION * LITERS_PER_SECOND_PER_PERSON
